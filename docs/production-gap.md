...
| P2-2 | **多模态 KB** | 图像事实源 + VLM 自动 caption → `search_visual`；CLIP 双塔后置 | **第 12 周已做**（2026-08-27） |
| P2-3 | **CRAG / Self-RAG** | 挂在 Profile 上的纠错层，非另起系统 | **第 12 周已做**（一次 rewrite + 全局开关） |
